(function (global, factory) {
    ...
    _createClass(ListItem, [{
      ...
      value: function render() {
        var _props = this.props,
            ...
            propIsOpen = _props.isOpen,
            defaultOpen = _props.defaultOpen,
            initiallyOpen = _props.initiallyOpen,
            props = _objectWithoutProperties(_props, ['style', 'className', 'tileStyle', 'tileClassName', 'disabled', 'leftIcon', 'leftAvatar', 'inset', 'rightIcon', 'rightAvatar', 'primaryText', 'secondaryText', 'threeLines', 'children', 'nestedItems', 'active', 'activeClassName', 'animateNestedItems', 'expanderIconChildren', 'expanderIconClassName', 'itemComponent', 'aria-setsize', 'aria-posinset', 'isOpen', 'defaultOpen', 'initiallyOpen']);
        ...
        if (nestedItems) {
          nestedList = _react2.default.createElement(
            _Collapse2.default,
            { collapsed: !isOpen, animate: animateNestedItems },
  ...
  ListItem.propTypes = {
     ...
     * @see {@link #component}
     */
    itemComponent: _react.PropTypes.oneOfType([_react.PropTypes.string, _react.PropTypes.func]).isRequired,
     ...
     */
    animateNestedItems: _react.PropTypes.bool,
     ...
     */
    'aria-setsize': _react.PropTypes.number,
