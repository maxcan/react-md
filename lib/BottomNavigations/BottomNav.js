    ...
    _createClass(BottomNav, [{
      ...
      value: function render() {
        var _props2 = this.props,
            ...
            index = _props2.index,
            propLabel = _props2.label,
            onClick = _props2.onClick,
            onNavChange = _props2.onNavChange,
            props = _objectWithoutProperties(_props2, ['active', 'fixed', 'className', 'iconClassName', 'iconChildren', 'colored', 'animate', 'index', 'label', 'onClick', 'onNavChange']);
