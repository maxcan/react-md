(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'react-dom', 'react-addons-css-transition-group', 'classnames', 'react-prop-types/lib/deprecated', '../constants/CSSTransitionGroupTick', './contextTypes', './Positions', '../Lists/List'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('react-dom'), require('react-addons-css-transition-group'), require('classnames'), require('react-prop-types/lib/deprecated'), require('../constants/CSSTransitionGroupTick'), require('./contextTypes'), require('./Positions'), require('../Lists/List'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.reactDom, global.reactAddonsCssTransitionGroup, global.classnames, global.deprecated, global.CSSTransitionGroupTick, global.contextTypes, global.Positions, global.List);
    global.Menu = mod.exports;
  }
})(this, function (exports, _react, _reactDom, _reactAddonsCssTransitionGroup, _classnames, _deprecated, _CSSTransitionGroupTick, _contextTypes, _Positions, _List) {
  'use strict';
    ...
    _createClass(Menu, [{
      ...
      value: function render() {
        var _props4 = this.props,
            ...
            cascading = _props4.cascading,
            propListId = _props4.listId,
            close = _props4.close,
            autoclose = _props4.autoclose,
            limitHeight = _props4.limitHeight,
            expanderIconChildren = _props4.expanderIconChildren,
            expanderIconClassName = _props4.expanderIconClassName,
            props = _objectWithoutProperties(_props4, ['id', 'className', 'listStyle', 'listClassName', 'isOpen', 'fullWidth', 'toggle', 'contained', 'children', 'position', 'onClose', 'cascading', 'listId', 'close', 'autoclose', 'limitHeight', 'expanderIconChildren', 'expanderIconClassName']);
  ...
  Menu.propTypes = {
     ...
     */
    position: _react.PropTypes.oneOf([Menu.Positions.TOP_LEFT, Menu.Positions.TOP_RIGHT, Menu.Positions.BOTTOM_LEFT, Menu.Positions.BOTTOM_RIGHT, Menu.Positions.CONTEXT, Menu.Positions.BELOW]).isRequired,
    ...
    close: (0, _deprecated2.default)(_react.PropTypes.func, 'Use `onClose` instead'),
    autoclose: (0, _deprecated2.default)(_react.PropTypes.bool, 'The menus will always autoclose as according to the specs'),
    limitHeight: (0, _deprecated2.default)(_react.PropTypes.bool, 'The menus will always be limited in height as according to the specs'),
    expanderIconClassName: (0, _deprecated2.default)(_react.PropTypes.node, 'The expander for cascading menus will now just be a simple rotate of the existing `ListItem` ' + 'expander icon'),
    expanderIconChildren: (0, _deprecated2.default)(_react.PropTypes.node, 'The expander for cascading menus will now just be a simple rotate of the existing `ListItem` ' + 'expander icon')
  };
  Menu.defaultProps = {
    component: 'div',
