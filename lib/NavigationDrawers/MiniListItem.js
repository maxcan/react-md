    ...
    _createClass(MiniListItem, [{
      ...
      value: function render() {
        var _props = this.props,
            ...
            props = _objectWithoutProperties(_props, ['style', 'className', 'tileStyle', 'tileClassName', 'leftIcon', 'leftAvatar', 'active', 'activeClassName', 'itemComponent', 'primaryText', 'secondaryText', 'rightIcon', 'rightAvatar', 'threeLines', 'expanderIconChildren', 'expanderIconClassName', 'children', 'defaultOpen', 'isOpen', 'inset', 'nestedItems', 'animateNestedItems']);
