    ...
    _createClass(TextField, [{
      ...
      value: function render() {
        ...
        var _props4 = this.props,
            ...
            icon = _props4.icon,
            propLabel = _props4.label,
            propPlaceholder = _props4.placeholder,
            propError = _props4.error,
            propActive = _props4.active,
            propFloating = _props4.floating,
            propLeftIcon = _props4.leftIcon,
            propRightIcon = _props4.rightIcon,
            onClick = _props4.onClick,
            onChange = _props4.onChange,
            onKeyDown = _props4.onKeyDown,
            onFocus = _props4.onFocus,
            adjustMinWidth = _props4.adjustMinWidth,
            propFloatingLabel = _props4.floatingLabel,
            props = _objectWithoutProperties(_props4, ['id', 'type', 'style', 'className', 'inputStyle', 'inputClassName', 'block', 'fullWidth', 'required', 'customSize', 'maxLength', 'errorText', 'helpText', 'helpOnFocus', 'disabled', 'leftIconStateful', 'rightIconStateful', 'passwordIconChildren', 'passwordIconClassName', 'lineDirection', 'paddedBlock', 'onDoubleClick', 'onTouchStart', 'onTouchMove', 'onTouchCancel', 'onTouchEnd', 'onMouseDown', 'onMouseUp', 'onMouseOver', 'onMouseLeave', 'ink', 'inlineIndicator', 'icon', 'label', 'placeholder', 'error', 'active', 'floating', 'leftIcon', 'rightIcon', 'onClick', 'onChange', 'onKeyDown', 'onFocus', 'adjustMinWidth', 'floatingLabel']);
