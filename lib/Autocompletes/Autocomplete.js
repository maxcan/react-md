(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'react-dom', 'react-addons-css-transition-group', 'classnames', '../utils/getField', '../utils/omit', '../utils/PropTypes/controlled', '../utils/PropTypes/invalidIf', '../constants/keyCodes', '../Lists/ListItem', '../Menus/Menu', '../TextFields/TextField'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('react-dom'), require('react-addons-css-transition-group'), require('classnames'), require('../utils/getField'), require('../utils/omit'), require('../utils/PropTypes/controlled'), require('../utils/PropTypes/invalidIf'), require('../constants/keyCodes'), require('../Lists/ListItem'), require('../Menus/Menu'), require('../TextFields/TextField'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.reactDom, global.reactAddonsCssTransitionGroup, global.classnames, global.getField, global.omit, global.controlled, global.invalidIf, global.keyCodes, global.ListItem, global.Menu, global.TextField);
    global.Autocomplete = mod.exports;
  }
})(this, function (exports, _react, _reactDom, _reactAddonsCssTransitionGroup, _classnames, _getField, _omit, _controlled, _invalidIf, _keyCodes, _ListItem, _Menu, _TextField) {
  'use strict';
  ...
  var Autocomplete = function (_PureComponent) {
    ...
    _createClass(Autocomplete, [{
      ...
      value: function _updateSuggestionStyle(isNew, isDeleted) {
        ...
        if (isNew) {
          ...
          if (msg) {
            ...
            this.setState({ suggestionStyle: _extends({}, suggestionStyle, { bottom: bottom }) });
          }
      ...
      key: '_mapToListItem',
      value: function _mapToListItem(match, i) {
      ...
      value: function render() {
        ...
        var _props7 = this.props,
            ...
            clearOnAutocomplete = _props7.clearOnAutocomplete,
            findInlineSuggestion = _props7.findInlineSuggestion,
            onAutocomplete = _props7.onAutocomplete,
            onMenuOpen = _props7.onMenuOpen,
            onMenuClose = _props7.onMenuClose,
            onBlur = _props7.onBlur,
            onFocus = _props7.onFocus,
            onKeyDown = _props7.onKeyDown,
            onMouseDown = _props7.onMouseDown,
            onChange = _props7.onChange,
            props = _objectWithoutProperties(_props7, ['fullWidth', 'block', 'style', 'className', 'listStyle', 'listClassName', 'textFieldStyle', 'textFieldClassName', 'inline', 'value', 'total', 'offset', 'filter', 'data', 'dataLabel', 'dataValue', 'deleteKeys', 'defaultValue', 'clearOnAutocomplete', 'findInlineSuggestion', 'onAutocomplete', 'onMenuOpen', 'onMenuClose', 'onBlur', 'onFocus', 'onKeyDown', 'onMouseDown', 'onChange']);
  ...
  Autocomplete.propTypes = {
     ...
     * @see {@link #offset}
     */
    total: (0, _invalidIf2.default)(_react.PropTypes.number, 'inline'),
