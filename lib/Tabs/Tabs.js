    ...
    _createClass(Tabs, [{
      ...
      value: function render() {
        ...
        var _props2 = this.props,
            ...
            propActiveIndex = _props2.activeTabIndex,
            defaultTabIndex = _props2.defaultTabIndex,
            defaultMedia = _props2.defaultMedia,
            desktopMinWidth = _props2.desktopMinWidth,
            onTabChange = _props2.onTabChange,
            props = _objectWithoutProperties(_props2, ['component', 'style', 'className', 'colored', 'centered', 'tabId', 'overflowMenu', 'overflowMenuLabel', 'overflowMenuIconChildren', 'overflowMenuIconClassName', 'nextIconChildren', 'nextIconClassName', 'previousIconChildren', 'previousIconClassName', 'activeTabIndex', 'defaultTabIndex', 'defaultMedia', 'desktopMinWidth', 'onTabChange']);
