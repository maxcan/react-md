(function (global, factory) {
    ...
    _createClass(Button, [{
      ...
      value: function render() {
        ...
        var _props = this.props,
            ...
            props = _objectWithoutProperties(_props, ['className', 'iconClassName', 'label', 'iconBefore', 'href', 'primary', 'secondary', 'flat', 'raised', 'floating', 'mini', 'fixed', 'fixedPosition', 'disabled', 'component', 'ink', 'tooltip', 'icon', 'forceIconSize', 'forceIconFontSize', 'noIcon', 'type', 'children']);
  ...
  Button.propTypes = {
     ...
     */
    label: (0, _invalidIf2.default)(_react.PropTypes.node, 'icon', 'floating'),
