    ...
    _createClass(SelectFieldColumn, [{
      ...
      value: function render() {
        ...
        var _props = this.props,
            ...
            propId = _props.id,
            scrollThreshold = _props.scrollThreshold,
            props = _objectWithoutProperties(_props, ['style', 'className', 'menuStyle', 'menuClassName', 'wrapperStyle', 'wrapperClassName', 'header', 'id', 'scrollThreshold']);
