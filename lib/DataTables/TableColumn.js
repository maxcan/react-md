(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'classnames', '../utils/getField', '../Tooltips/injectTooltip', '../FontIcons/Collapser', '../Helpers/IconSeparator'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('classnames'), require('../utils/getField'), require('../Tooltips/injectTooltip'), require('../FontIcons/Collapser'), require('../Helpers/IconSeparator'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.classnames, global.getField, global.injectTooltip, global.Collapser, global.IconSeparator);
    global.TableColumn = mod.exports;
  }
})(this, function (exports, _react, _classnames, _getField, _injectTooltip, _Collapser, _IconSeparator) {
  'use strict';
    ...
    _createClass(TableColumn, [{
      ...
      value: function render() {
        var _props = this.props,
            ...
            props = _objectWithoutProperties(_props, ['className', 'numeric', 'adjusted', 'header', 'children', 'sorted', 'sortIconChildren', 'sortIconClassName', 'tooltip', 'selectColumnHeader', '__fixedColumn', 'plain', 'scope']);
  ...
  TableColumn.propTypes = {
     ...
     * header columns.
     */
    scope: _react.PropTypes.oneOf(['row', 'col'])
  };
