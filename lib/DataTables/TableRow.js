(function (global, factory) {
  ...
  var TableRow = function (_Component) {
    ...
    function TableRow(props, context) {
      ...
      _this._handleCheckboxClick = _this._handleCheckboxClick.bind(_this);
      return _this;
    }
    ...
    _createClass(TableRow, [{
      ...
      value: function _handleCheckboxClick(checked, e) {
      ...
      value: function _setLongestColumn(row) {
        ...
        this.setState({ biggest: biggest, selects: selects, rowIndex: rowIndex });
      }
    }, {
      key: 'render',
      value: function render() {
        ...
        var _props = this.props,
            ...
            props = _objectWithoutProperties(_props, ['className', 'children', 'selected', 'onCheckboxClick', 'autoAdjust']);
