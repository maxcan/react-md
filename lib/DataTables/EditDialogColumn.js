    ...
    _createClass(EditDialogColumn, [{
      ...
      value: function render() {
        ...
        var _props2 = this.props,
            ...
            props = _objectWithoutProperties(_props2, ['style', 'className', 'dialogStyle', 'dialogClassName', 'textFieldStyle', 'textFieldClassName', 'inputStyle', 'inputClassName', 'maxLength', 'title', 'okLabel', 'cancelLabel', 'large', 'label', 'placeholder', 'inline', 'inlineIconChildren', 'inlineIconClassName', 'noIcon', 'header', 'enforceMinWidth', 'id', 'value', 'defaultValue', 'scrollThreshold', 'transitionDuration', 'okOnOutsideClick', 'onMouseOver', 'onMouseLeave', 'onTouchStart', 'onTouchEnd', 'onOkClick', 'onCancelClick']);
