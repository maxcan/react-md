(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'react-dom', 'classnames', '../utils/getField', '../utils/PropTypes/controlled', '../Papers/Paper', '../FontIcons/Collapser', '../Helpers/AccessibleFakeButton', '../Helpers/Collapse', './PanelContent'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('react-dom'), require('classnames'), require('../utils/getField'), require('../utils/PropTypes/controlled'), require('../Papers/Paper'), require('../FontIcons/Collapser'), require('../Helpers/AccessibleFakeButton'), require('../Helpers/Collapse'), require('./PanelContent'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.reactDom, global.classnames, global.getField, global.controlled, global.Paper, global.Collapser, global.AccessibleFakeButton, global.Collapse, global.PanelContent);
    global.ExpansionPanel = mod.exports;
  }
})(this, function (exports, _react, _reactDom, _classnames, _getField, _controlled, _Paper, _Collapser, _AccessibleFakeButton, _Collapse, _PanelContent) {
  'use strict';
    ...
    _createClass(ExpansionPanel, [{
      ...
      value: function render() {
        var _props3 = this.props,
            ...
            propAnimateContent = _props3.animateContent,
            propExpanded = _props3.expanded,
            defaultExpanded = _props3.defaultExpanded,
            closeOnSave = _props3.closeOnSave,
            closeOnCancel = _props3.closeOnCancel,
            onSave = _props3.onSave,
            onCancel = _props3.onCancel,
            onExpandToggle = _props3.onExpandToggle,
  ...
  ExpansionPanel.propTypes = {
     ...
     */
    animateContent: _react.PropTypes.bool
  };
