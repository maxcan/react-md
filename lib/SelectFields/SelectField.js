(function (global, factory) {
  ...
  var TOP_RIGHT = _Positions2.default.TOP_RIGHT,
      TOP_LEFT = _Positions2.default.TOP_LEFT,
      BELOW = _Positions2.default.BELOW;

  var SelectFieldPositions = { TOP_RIGHT: TOP_RIGHT, TOP_LEFT: TOP_LEFT, BELOW: BELOW };
    ...
    _createClass(SelectField, [{
      ...
      value: function render() {
        ...
        var _props6 = this.props,
            ...
            propError = _props6.error,
            propValue = _props6.value,
            propMenuId = _props6.menuId,
            propListId = _props6.listId,
            propIsOpen = _props6.isOpen,
            propPlaceholder = _props6.placeholder,
            propLabel = _props6.label,
            itemLabel = _props6.itemLabel,
            itemValue = _props6.itemValue,
            defaultOpen = _props6.defaultOpen,
            defaultValue = _props6.defaultValue,
            keyboardMatchingTimeout = _props6.keyboardMatchingTimeout,
            onMenuToggle = _props6.onMenuToggle,
            menuStyle = _props6.menuStyle,
            menuClassName = _props6.menuClassName,
            initiallyOpen = _props6.initiallyOpen,
            floatingLabel = _props6.floatingLabel,
            noAutoAdjust = _props6.noAutoAdjust,
            adjustMinWidth = _props6.adjustMinWidth,
            props = _objectWithoutProperties(_props6, ['id', 'style', 'className', 'listStyle', 'listClassName', 'inputStyle', 'inputClassName', 'disabled', 'menuItems', 'position', 'stretchList', 'errorText', 'helpText', 'helpOnFocus', 'required', 'fullWidth', 'error', 'value', 'menuId', 'listId', 'isOpen', 'placeholder', 'label', 'itemLabel', 'itemValue', 'defaultOpen', 'defaultValue', 'keyboardMatchingTimeout', 'onMenuToggle', 'menuStyle', 'menuClassName', 'initiallyOpen', 'floatingLabel', 'noAutoAdjust', 'adjustMinWidth']);
