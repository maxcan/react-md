(function (global, factory) {
  ...
  var ClockFace = function (_PureComponent) {
    ...
    function ClockFace(props) {
      ...
      _this._enableMouseMoving = _this._enableMouseMoving.bind(_this);
      _this._disableMouseMoving = _this._disableMouseMoving.bind(_this);
    ...
    _createClass(ClockFace, [{
      ...
      value: function _handleMouseUp(e) {
        ...
        var _props = this.props,
            onTimeChosen = _props.onTimeChosen,
      ...
      key: '_enableMouseMoving',
      value: function _enableMouseMoving() {
      ...
      key: '_disableMouseMoving',
      value: function _disableMouseMoving() {
        window.removeEventListener('mousemove', this._handleMouseMove);
      ...
      value: function render() {
        var _props3 = this.props,
            time = _props3.time,
            minutes = _props3.minutes,
            timePeriod = _props3.timePeriod,
  ...
  ClockFace.propTypes = {
    ...
    onTimeChosen: _react.PropTypes.func.isRequired
  };
