(function (global, factory) {
  ...
  var TimePicker = function (_PureComponent) {
    ...
    function TimePicker(props) {
      ...
      _this._handleTimeChosen = _this._handleTimeChosen.bind(_this);
      return _this;
    }
    ...
    _createClass(TimePicker, [{
      ...
      key: '_handleTimeChosen',
      value: function _handleTimeChosen() {
      ...
      value: function render() {
        ...
        var _props3 = this.props,
            okLabel = _props3.okLabel,
            okPrimary = _props3.okPrimary,
            onOkClick = _props3.onOkClick,
            cancelLabel = _props3.cancelLabel,
            cancelPrimary = _props3.cancelPrimary,
            onCancelClick = _props3.onCancelClick,
            style = _props3.style,
            className = _props3.className,
            setTimeMode = _props3.setTimeMode,
            setTempTime = _props3.setTempTime,
            timeMode = _props3.timeMode,
            tempTime = _props3.tempTime,
            hours = _props3.hours,
