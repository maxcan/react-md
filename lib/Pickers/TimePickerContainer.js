(function (global, factory) {
    ...
    _createClass(TimePickerContainer, [{
      ...
      value: function _toggleOpen(e) {
        ...
        if (typeof this.props.isOpen === 'undefined' && typeof this.props.visible === 'undefined') {
          var hoverMode = this.props.hoverMode;
      ...
      value: function _handleCancelClick(e) {
        ...
        var state = { tempTime: this.state.time };
        if (typeof this.props.isOpen === 'undefined' && typeof this.props.visible === 'undefined') {
          state.visible = false;
        }
      ...
      value: function render() {
        ...
        var _props3 = this.props,
            ...
            defaultTimeMode = _props3.defaultTimeMode,
            onVisibilityChange = _props3.onVisibilityChange,
            isOpen = _props3.isOpen,
            initialTimeMode = _props3.initialTimeMode,
            initiallyOpen = _props3.initiallyOpen,
            props = _objectWithoutProperties(_props3, ['style', 'className', 'pickerStyle', 'pickerClassName', 'inputStyle', 'inputClassName', 'textFieldStyle', 'textFieldClassName', 'id', 'disabled', 'label', 'placeholder', 'icon', 'inline', 'displayMode', 'fullWidth', 'lineDirection', 'closeOnEsc', 'hoverMode', 'renderNode', 'lastChild', 'animateInline', 'block', 'paddedBlock', 'active', 'error', 'floating', 'required', 'leftIconStateful', 'rightIcon', 'rightIconStateful', 'customSize', 'errorText', 'helpText', 'helpOnFocus', 'inlineIndicator', 'aria-label', 'value', 'visible', 'defaultValue', 'defaultVisible', 'defaultTimeMode', 'onVisibilityChange', 'isOpen', 'initialTimeMode', 'initiallyOpen']);
  ...
  TimePickerContainer.propTypes = {
     ...
     */
    hoverMode: _react.PropTypes.bool,

    /**
     * Boolean if the inline time picker's visibility should be animated.
     */
    animateInline: _react.PropTypes.bool,
