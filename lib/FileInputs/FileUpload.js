(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'react-dom', './FileInput', '../utils/omit'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('react-dom'), require('./FileInput'), require('../utils/omit'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.reactDom, global.FileInput, global.omit);
    global.FileUpload = mod.exports;
  }
})(this, function (exports, _react, _reactDom, _FileInput, _omit) {
  'use strict';
    ...
    _createClass(FileUpload, [{
      ...
      value: function abort(file) {
        ...
        if (reader) {
          ...
          this.setState((0, _omit2.default)(this.state, [fileName]));
        }
      }
    }, {
      key: '_uploadFile',
      value: function _uploadFile(file) {
        ...
        fr.onload = function (e) {
          ...
          _this2.setState((0, _omit2.default)(_this2.state, [name]));
        };
      ...
      value: function render() {
        var _props3 = this.props,
            ...
            onAbort = _props3.onAbort,
            onError = _props3.onError,
            onSizeError = _props3.onSizeError,
            props = _objectWithoutProperties(_props3, ['maxSize', 'readAs', 'onLoad', 'onLoadStart', 'onLoadEnd', 'onProgress', 'onAbort', 'onError', 'onSizeError']);
