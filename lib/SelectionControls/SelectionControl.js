(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'classnames', 'react-prop-types/lib/deprecated', 'react-prop-types/lib/isRequiredForA11y', '../utils/getField', '../utils/PropTypes/oneRequiredForA11y', '../utils/StringUtils/capitalizeFirst', '../Helpers/AccessibleFakeInkedButton', '../FontIcons/FontIcon', './SwitchTrack'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('classnames'), require('react-prop-types/lib/deprecated'), require('react-prop-types/lib/isRequiredForA11y'), require('../utils/getField'), require('../utils/PropTypes/oneRequiredForA11y'), require('../utils/StringUtils/capitalizeFirst'), require('../Helpers/AccessibleFakeInkedButton'), require('../FontIcons/FontIcon'), require('./SwitchTrack'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.classnames, global.deprecated, global.isRequiredForA11y, global.getField, global.oneRequiredForA11y, global.capitalizeFirst, global.AccessibleFakeInkedButton, global.FontIcon, global.SwitchTrack);
    global.SelectionControl = mod.exports;
  }
})(this, function (exports, _react, _classnames, _deprecated, _isRequiredForA11y, _getField, _oneRequiredForA11y, _capitalizeFirst, _AccessibleFakeInkedButton, _FontIcon, _SwitchTrack) {
  'use strict';
    ...
    _createClass(SelectionControl, [{
      ...
      value: function render() {
        var _props3 = this.props,
            ...
            propChildren = _props3.checked,
            onChange = _props3.onChange,
            checkedIcon = _props3.checkedIcon,
            uncheckedIcon = _props3.uncheckedIcon,
            checkedRadioIconChildren = _props3.checkedRadioIconChildren,
            checkedRadioIconClassName = _props3.checkedRadioIconClassName,
            uncheckedRadioIconChildren = _props3.uncheckedRadioIconChildren,
            uncheckedRadioIconClassName = _props3.uncheckedRadioIconClassName,
            checkedCheckboxIconChildren = _props3.checkedCheckboxIconChildren,
            checkedCheckboxIconClassName = _props3.checkedCheckboxIconClassName,
            uncheckedCheckboxIconChildren = _props3.uncheckedCheckboxIconChildren,
            uncheckedCheckboxIconClassName = _props3.uncheckedCheckboxIconClassName,
            tooltip = _props3.tooltip,
            __superSecreteProp = _props3.__superSecreteProp,
            props = _objectWithoutProperties(_props3, ['id', 'style', 'className', 'inline', 'type', 'name', 'value', 'disabled', 'labelBefore', 'onBlur', 'onFocus', 'aria-label', 'label', 'checked', 'onChange', 'checkedIcon', 'uncheckedIcon', 'checkedRadioIconChildren', 'checkedRadioIconClassName', 'uncheckedRadioIconChildren', 'uncheckedRadioIconClassName', 'checkedCheckboxIconChildren', 'checkedCheckboxIconClassName', 'uncheckedCheckboxIconChildren', 'uncheckedCheckboxIconClassName', 'tooltip', '__superSecreteProp']);
  ...
  SelectionControl.propTypes = {
     ...
     */
    'aria-label': (0, _oneRequiredForA11y2.default)(_react.PropTypes.string, 'label'),
